...
final fiatCurrencyListNotifier =
    NotifierProvider<FiatCurrencyListNotifier, CurrencyListNotifierState>(
  FiatCurrencyListNotifier.new,
);

class FiatCurrencyListNotifier extends Notifier<CurrencyListNotifierState> {
  @override
  CurrencyListNotifierState build() => const CurrencyListNotifierState();

  Future<void> getCurrencies() async {
    final result =
        await ref.read(currencyListRepositoryProvider).getFiatCurrencies();
    state = result.fold(
